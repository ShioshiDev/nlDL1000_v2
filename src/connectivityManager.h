...
private:
    ...
    static const unsigned long PING_INTERVAL_MS = NETWORK_PING_INTERVAL_MS;
    static const unsigned long PING_TIMEOUT_MS = NETWORK_PING_TIMEOUT_MS;
    static const int PING_RETRY_COUNT = NETWORK_PING_RETRY_COUNT;
